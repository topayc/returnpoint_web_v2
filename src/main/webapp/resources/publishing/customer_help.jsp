...
<body class="p_customer_help">	
	...
	<ul class="submenu">
		...
		<li class="active"><a href="./customer_help.jsp">회원문의</a></li>
	</ul>
	<section>
		<h4>회원문의</h4>
		<hr>
		<form>
			...
			<div class="form-group">
				<textarea class="form-control" rows="5" id="comment" placeholder="내용"></textarea>
			</div>
			<div class="btns2"><button type="submit" class="btn btn-submit">보내기</button><button type="submit" class="btn btn-submit-cancel">취소</button></div>
		</form>
	</section>
	<!-- content end -->
	<footer>
