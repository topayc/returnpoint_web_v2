	...
	<section>
		<div id="main-carousel" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="item active"><img src="../images/index_img01.jpg" /></div>
				<div class="item"><img src="../images/index_img02.jpg" /></div>
				<div class="item"><img src="../images/index_img03.jpg" /></div>
				...
				<div class="txt_group">
					...
					<p class="home_stitle">
						미래를 지향하는 안정된 기업의 신뢰와<br />성실로 최선을 다하는 차별화된 서비스
					</p>
				</div>
			</div>
		</div>
