	...
	<section>
		...
		<form>	
			<div class="form-group">
				<label for="email">이메일</label> <input type="email"	class="form-control" id="email"  value="guest@returnp.com" disabled>
			</div>
			<div class="form-group">
				<label for="pwd">비밀번호</label> <input type="password" class="form-control" id="pwd">
			</div>
			<div class="form-group">
				<label for="pwdconfirm">비밀번호 확인</label> <input type="password" class="form-control" id="pwdconfirm">
			</div>
			<div class="form-group">
				<label for="name">이름</label> <input type="text"	class="form-control" id="name"  value="홍길동" disabled>
			</div>
			...
			<div class="form-group">
				<label for="phone"> 핸드폰</label> <input type="tel"	class="form-control" id="phone">
			</div>		
			<div class="btns2"><button type="button" class="btn btn-submit">수정</button><button type="button" class="btn btn-submit-cancel">취소</button></div>
		</form>
	</section>
	<!-- content end -->
	<footer>
