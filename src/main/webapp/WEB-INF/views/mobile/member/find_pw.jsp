...
<body class="p_find">
	...
	<!-- content begin -->
	<ul class="submenu">
		<li><a href="/member/find_email.do"><spring:message code="label.findEmail" /></a></li>
		<li class="active"><a href="/member/find_pw.do"><spring:message code="label.findEmailPassword" /></a></li>
	</ul>
	<section>
