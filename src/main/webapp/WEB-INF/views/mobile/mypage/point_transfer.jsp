...
<body class="p_point">	
	...
	<ul class="submenu">
		...
		<li class="active"><a href="/mypage/point_transfer.do"><spring:message code="label.switchPoints"/></a></li>
		<li><a href="/mypage/point_gift.do"><spring:message code="label.pointGift"/></a></li>
	</ul>
