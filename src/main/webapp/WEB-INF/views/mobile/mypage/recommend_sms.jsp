...
function sendRecommendSMSCheck(memberName, memberEmail){
	...
	$("input[type='checkbox']:checked").each(function(index,item){
		smsData.push({
			message :  window.location.protocol + "//" + window.location.host + "/member/join.do?recommender=" +btoa(encodeURIComponent(parameters["recommender"])),
			phoneNumber : $(this).attr('phoneNumber'),
			url : window.location.protocol + "//" + window.location.host + "/member/join.do?recommender=" +btoa(encodeURIComponent(parameters["recommender"]))
		})
	});
